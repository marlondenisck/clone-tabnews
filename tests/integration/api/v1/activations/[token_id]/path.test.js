...
describe("PATCH /api/v1/activations/[token_id]", () => {
  describe("Anonymous user", () => {
    test("Quando o token não existe", async () => {
    ...
    test("Quando o token expirou", async () => {
      jest.useFakeTimers({
    ...
    test("Quando o token já foi utilizado", async () => {
      const createdUser = await orchestrator.createUser();
    ...
    test("Quando o token é válido", async () => {
      const createdUser = await orchestrator.createUser();
      const activationToken = await activation.create(createdUser.id);
    ...
    test("Quando o token é válido, mas o usuário já está ativado", async () => {
      const createdUser = await orchestrator.createUser();
  ...
  describe("Usuário padrão", () => {
    test("Quando o token é válido, mas o usuário já está logado", async () => {
