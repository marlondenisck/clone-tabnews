---
description: "Agente principal do projeto clone-tabnews. Use para qualquer tarefa de desenvolvimento: criar rota API, endpoint, migration, teste, tabela no banco, recurso REST, integração com banco de dados PostgreSQL, Next.js."
tools: [read, search, agent]
agents: [test-writer, migration-writer, api-route-writer]
---
